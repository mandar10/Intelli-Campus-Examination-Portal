              ...
              <li class="user-header">
                ...
                <p>
                  <?php
                    echo $rows['firstname'].' '.$surname;
                  ?>
                  <small><?php if(substr($_SESSION['sap'],0,1)=='6') {echo 'Member Since '.date("M Y",strtotime($rows['doj']));}?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <?php
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $rows['firstname'].' '.$surname; ?></p>
      ...
      <li class="header">What we have</li>
        ...
        if(substr($_SESSION['sap'],0,1)=='6')
        {
          echo '<li><a href="studentcreg.php?redirect=false"><i class="fa fa-user"></i> <span>Student Registration Form</span></a></li>';

          echo '<li><a href="hall_ticket.php?sap='.$_SESSION['sap'].'" ><i class="fa fa-user"></i> <span>Hall Ticket</span></a></li>';

          echo '<li><a href="main_forum.php"><i class="fa fa-user"></i> <span>Student Forum</span></a></li>';
        }
        if($_SESSION['sap']=='60003160001')
        {
          echo '<li><a href="admin.php?redirect=false"><i class="fa fa-user"></i> <span>Student Allocation</span></a></li>';
          echo '<li><a href="invig_ad.php?redirect=false"><i class="fa fa-user"></i> <span>Invigilator Allocation</span></a></li>';
        }
        ?>
