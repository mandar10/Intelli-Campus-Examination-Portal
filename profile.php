  ...
  <div class="content-wrapper">
      ...
      <div class="col-md-12" style="padding-left:10px;padding-right:10px;">
        <div class="box boxzol" style="">
          <div class="box-header with-border bg-title2" style="">
            <h2 class="box-title" style="font-size:22px;color:white;"><?php echo $rows["firstname"].' '.$surname;?>'s Profile</h2>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-3 pro-box" style="">
                <h3 class="text-center" style="font-size:20px;margin-top:10px"><b><?php echo $rows["firstname"].' '.$surname;?></b></h3>
              ...
              <div class="pm col-md-5" style="display:flex;justify-content:center;">
                <div class="pmi profile-info" >
                  ...
                  <span style="font-size:16px;"><b>Name:</b></span>&nbsp&nbsp&nbsp<span style="font-size:16px;"><?php echo $rows["firstname"].' '.$surname;?></span><br>
              ...
              <div class="col-md-4">
                ...
                <div class="box " style="border-top:0;">
                  <div class="box-header text-center">
                    <h3 class="box-title" style="font-size:20px;"><b>Timetable</b></h3>

                  </div>
                  <!-- /.box-header -->
                  <div class="box-body no-padding">
                    <?php
                    if(substr($_SESSION['sap'],0,1)=='6' && $_SESSION['sap']!=60003160001)
                    {
                      $query1="SELECT * FROM allocation WHERE sap='".$_SESSION['sap']."' ";
                      $query_run1=mysqli_query($con,$query1);
                      while($row1=mysqli_fetch_assoc($query_run1))
                      {
                        echo $row1['course'].' '.$row1['day'].' '.$row1['roomno'].'<br>';
                      }
                    }
                    else if(substr($_SESSION['sap'],0,1)=='7')
                    {
                      $query1="SELECT * FROM invig_allocation WHERE sap='".$_SESSION['sap']."' ";
                      $query_run1=mysqli_query($con,$query1);
                      while($row1=mysqli_fetch_assoc($query_run1))
                      {
                        echo $row1['day'].' '.$row1['roomno'].'<br>';
                      } 
                    }
                    ?>
                  </div>
      ...
      <div class="col-md-7 col-md-offset-1 forum">
        ...
        <div class="box box-primary" style="border-top-color:#d2d6de;">
          <div class="box-header with-border bg-title" style="">
            <h3 class="box-title" style="color:white;">Forum Created by  <?php echo $rows["firstname"].' '.$surname;?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
    ...
    <div class="row" style="margin:10px -7px; ">
      ...
      <div class="col-md-7 col-md-offset-1 forum">
        ...
        <div class="box box-primary" style="border-top-color:#d2d6de;">
          <div class="box-header with-border bg-title" style="">
            <h3 class="box-title" style="color:white;">Products to sell in G-Store by <?php echo $rows["firstname"].' '.$surname;?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <ul class="products-list product-list-in-box">
